...
class _InputPageState extends State<InputPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: dummy.getDummy(norm),
        builder: (context, AsyncSnapshot<Dummy> snapshot) {
        ...
        children: <Widget>[
          ...
          Expanded(
            ...
            child: ListView.builder(
              itemCount: dummy.kunjungan.length,
              itemBuilder: (context, index) {
                Kunjungan kunjungan = dummy.kunjungan[index];
